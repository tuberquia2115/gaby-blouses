...
export const UsersTable = ({ users }: Props) => (
  <div className='overflow-scroll mb-10'>
    <table className="min-w-full">
      ...
      <tbody>
        {users.map((user) => (
          <tr key={user.id} className="bg-white border-b transition duration-300 ease-in-out hover:bg-blue-100">
            ...
            <td className="flex items-center justify-center text-sm  text-gray-900 font-light px-6 py-4 whitespace-nowrap">
              <select
                ...
                className="text-sm min-w-10 p-2 outline-none focus:outline-none list-none text-gray-900"
              >
